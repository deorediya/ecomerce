...
<head>
        ...
        <!-- Title Of Site -->
        <title>Tana-Bana - Clothing Shop Online from trendy apparels for women, men & kids at best prices.</title>
        <!-- Favicon -->
        ...
        <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6 col-sm-6 col-md-6 col-lg-6 text-right">
                            <i class="icon anm anm-phone-l me-2"></i><a href="tel: +918959171709">(+91) 895 917 1709 </a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-1 col-sm-1 col-md-1 col-lg-5 align-self-center d-menu-col hdr-menu-left menu-position-left">
                            <nav class="navigation" id="AccessibleNav">
                                <ul id="siteNav" class="site-nav medium left">
                                    <li class="lvl1 parent"><a href="Product-list.html">New Arrivals</a></li>
                                    <li class="lvl1 parent"><a href="Product-list.html">Most Trending</a></li>
                                    <li class="lvl1 parent dropdown"><a href="Product-list.html">Shop <i class="icon anm anm-angle-down-l"></i></a>
                                        <ul class="dropdown">
                                            <li><a href="Product-list.html" class="site-nav lvl-2">T-Shits</a></li>
                                            <li><a href="Product-list.html" class="site-nav lvl-2">Shits</a></li>
                                            <li><a href="Product-list.html" class="site-nav lvl-2">Jeans</a></li>
                                            <li><a href="Product-list.html" class="site-nav lvl-2">Jackets</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </nav>
                        ...
                        <div class="logo col-4 col-sm-4 col-md-4 col-lg-2 align-self-center">
                            <a class="logoImg" href="index.html">
                                <img class="mx-lg-auto default-logo" src="assets/images/logo.png" alt="Tana-Bana - Clothing - Shop Online" title="Tana-Bana - Clothing - Shop Online">
                                <span class="logo-txt d-none">Tana-Bana</span>
                            </a>
                        </div>
                        <!--End Logo-->
                        <!--Right Icon-->
                        <div class="col-8 col-sm-8 col-md-8 col-lg-5 align-self-center icons-col text-right">                         
                            ...
                            <div class="header-cart iconset" title="Cart">
                                <a href="cart.html" class="header-cart btn-minicart clr-none"><i class="hdr-icon icon anm anm-basket-l"></i><span class="cart-count">2</span></a>
                            </div>
                            <!--End Minicart-->
                            <!--Mobile Toggle-->
            ...
            <div class="mobile-nav-wrapper" role="navigation">
                ...
                <ul id="MobileNav" class="mobile-nav">
                    <li class="lvl1 parent"><a href="Product-list.html">New Arrivals</a></li>
                    <li class="lvl1 parent"><a href="Product-list.html">Most Trending</a></li>
                    <li class="lvl1 parent dropdown"><a href="#">Shop <i class="icon anm anm-angle-down-l"></i></a>
                        <ul class="dropdown">
                            <li><a href="Product-list.html" class="site-nav lvl-2">T-Shits</a></li>
                            <li><a href="Product-list.html" class="site-nav lvl-2">Shits</a></li>
                            <li><a href="Product-list.html" class="site-nav lvl-2">Jeans</a></li>
                    ...
                    <li class="mobile-menu-bottom">
                        <div class="mobile-links"> 
                            <ul class="list-inline d-inline-flex flex-column w-100">
                                ...
                                <li><a href="tel:(+91) 895 917 1709 " class="d-flex align-items-center"><i class="icon anm anm-phone-l"></i> (+91) 895 917 1709 </a></li>
                                <li><a href="mailto:support@thetanabana.com" class="d-flex align-items-center"><i class="icon anm anm-envelope-l"></i> support@thetanabana.com</a></li>
                            </ul>
                        </div>
                                        ...
                                        <div class="slideshow-content-in">
                                            <div class="wrap-caption animation style1">
                                                ...
                                                <div class="ss-btnWrap">
                                                    <a class="btn btn-primary" href="Product-list.html">Shop Women</a>
                                                    <a class="btn btn-secondary" href="Product-list.html">Shop Men</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="slideshow-content-in">
                                            <div class="wrap-caption animation style1">
                                                ...
                                                <div class="ss-btnWrap d-flex-justify-start">
                                                    <a class="btn btn-primary" href="Product-list.html">Explore Now!</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="slideshow-content slideshow-overlay middle-right">
                                        <div class="slideshow-content-in">
                                            <div class="wrap-caption animation style1">
                                                ...
                                                <div class="ss-btnWrap">
                                                    <a class="btn btn-primary" href="Product-list.html">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="container">
                        <div class="service-info row col-row row-cols-lg-4 row-cols-md-4 row-cols-sm-2 row-cols-2 text-center">
                            ...
                            <div class="service-wrap col-item">
                                ...
                                <div class="service-content">
                                    <h3 class="title mb-2">Free delivery </h3>
                                    <span class="text-muted">Free shipping on orders over ₹999</span>
                                </div>
                            </div>
                            <div class="service-wrap col-item">
                                <div class="service-icon mb-3">
                                ...
                                <div class="service-content">
                                    ...
                                    <span class="text-muted">We accept all credit cards</span>
                                </div>
                            </div>
                            <div class="service-wrap col-item">
                                <div class="service-icon mb-3">
                                ...
                                <div class="service-content">
                                    <h3 class="title mb-2">Free Replacement</h3>
                                    <span class="text-muted">7-days free return policy</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="collection-slider-5items gp15 arwOut5 hov-arrow">
                            <div class="category-item zoomscal-hov">
                                <a href="Product-list.html" class="category-link clr-none">
                        ...
                        <div class="tabs-listing">
                            <ul class="nav nav-tabs style1 justify-content-center" id="productTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link head-font active" id="bestsellers-tab" data-bs-toggle="tab" data-bs-target="#bestsellers" type="button" role="tab" aria-controls="bestsellers" aria-selected="true">Most Trending</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <div class="tab-pane show active" id="bestsellers" role="tabpanel" aria-labelledby="bestsellers-tab">
                                    ...
                                    <div class="grid-products grid-view-items">
                                        <div class="row col-row product-options row-cols-xl-4 row-cols-lg-4 row-cols-md-3 row-cols-sm-3 row-cols-2">                                   
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-image">
                                                        <!-- Start Product Image -->
                                                        <a href="product-detail.html" class="product-img rounded-3"><img class="blur-up lazyload" src="assets/images/products/product1.jpg" alt="Product" title="Product" width="625" height="808" /></a>
                                                        <!-- End Product Image -->
                                                    </div>
                                                    <!-- End Product Image -->
                                                    ...
                                                    <div class="product-details text-center">
                                                        ...
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Oxford Cuban Shirt</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-image">
                                                        <!-- Start Product Image -->
                                                        <a href="product-detail.html" class="product-img rounded-3">
                                                            <!-- Image -->
                                                    ...
                                                    <div class="product-details text-center">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Cuff Beanie Cap</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-details text-center">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Flannel Collar Shirt</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-details text-center">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Cotton Hooded Hoodie</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-details text-center">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Hooded Neck Hoodies</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-details text-center">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Foldable Duffel Bag</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-details text-center">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">High-Waisted Pant</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-details text-center">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Narror Neck Tie</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                                        ...
                                        <div class="view-collection text-center mt-4 mt-md-5">
                                            <a href="Product-list.html" class="btn btn-secondary btn-lg">View Collection</a>
                                        </div>
                                    </div>
                                    <!--End Product Grid-->
                                </div>
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-details text-center">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Men\'s Cheater Jacket</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-details text-center">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Casual Mustard Shirt</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-details">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Backpack Laptop Bag</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-details">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Cotton Casual Tshirt</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-details">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Ankle Casual Pants</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                                            ...
                                            <div class="item col-item">
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-details">
                                                        <!-- Product Name -->
                                                        <div class="product-name">
                                                            <a href="product-detail.html">Straight Fit Trousers</a>
                                                        </div>
                                                        <!-- End Product Name -->
                                                        <!-- Product Price -->
                                                        <div class="product-price">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-contact">
                                ...
                                <p class="address d-flex"><i class="icon anm anm-map-marker-al pt-1"></i>  Tana bana fabrics, Guru nanak ward, bamhnoda road, pangar, Dist. Jabalpur, (M.P)  - 483220,  India</p>
                                <p class="phone d-flex align-items-center"><i class="icon anm anm-phone-l"></i>  <b class="me-1 d-none">Phone:</b> <a href="tel:(+91) 895 917 1709">(+91) 895 917 1709 </a></p>
                                <p class="email d-flex align-items-center"><i class="icon anm anm-envelope-l"></i> <b class="me-1 d-none">Email:</b> <a href="mailto:support@thetanabana.com">support@thetanabana.com</a></p>
                ...
                <div class="footer-bottom clearfix">
                    <div class="container">
                        <div class="d-flex-center flex-column justify-content-md-between flex-md-row-reverse">
                            <div class="copytext">&copy; 2023 TanaBana. All Rights Reserved.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="menubar-mobile d-flex align-items-center justify-content-between d-lg-none">
                <div class="menubar-shop menubar-item">
                    <a href="Product-list.html"><i class="menubar-icon anm anm-th-large-l"></i><span class="menubar-label">Shop</span></a>
                </div>
                ...
                <div class="menubar-cart menubar-item">
                    <a href="cart.html" class="btn-minicart">
